...
class SchedulerDataSourceResult extends DataSourceResult
{
    ...
    {
         $properties = array_merge($properties, ['Title', 'strftime(\'%Y-%m-%dT%H:%M:%SZ\', Start) as Start', 'strftime(\'%Y-%m-%dT%H:%M:%SZ\', End) as End', 'IsAllDay', 'StartTimezone', 'EndTimezone', 'Description', 'RecurrenceID', 'RecurrenceRule', 'RecurrenceException']);
