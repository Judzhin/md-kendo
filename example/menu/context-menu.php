...
<?php
    ...
    $first->addItem(
        ["text" => "Reply to Sender", "imageUrl" => "../content/web/toolbar/reply.png"],
        ["text" => "Reply to All", "imageUrl" => "../content/web/toolbar/reply.png"]
    );
    ...
    $fourth->addItem(
        ["text" => "None"],
        ["text" => "Important", "imageUrl" => "../content/web/toolbar/important.png"],
        ["text" => "Work", "imageUrl" => "../content/web/toolbar/todo.png"],
        ["text" => "Personal", "imageUrl" => "../content/web/toolbar/done.png"],
        ["text" => "New Label"]
    );
