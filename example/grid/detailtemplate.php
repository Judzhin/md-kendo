...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (array_key_exists('details', $_GET)) {
        echo json_encode($result->read('Orders', ['OrderID', 'ShipCountry', 'ShipAddress', 'ShipName', 'EmployeeID'], $request));
    } else {
        echo json_encode($result->read('Employees', ['EmployeeID', 'FirstName', 'LastName', 'Country', 'City', 'Title', 'Address', 'HomePhone'], $request));
    }
