...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (array_key_exists('type', $_GET)) {
        echo json_encode($result->read('Categories', ['CategoryID', 'CategoryName'], $request));
    } else {
        echo json_encode($result->read('Products', ['ProductID', 'ProductName', 'UnitPrice', 'QuantityPerUnit', 'CategoryID'], $request));
    }
