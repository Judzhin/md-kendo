...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($type) {
        ...
        case 'destroy':
            ...
            break;
        case 'categories':
            $result = $result->read('Categories', ['CategoryID', 'CategoryName']);
            break;
    }
    ...
    if ($type != 'categories') {
        ...
        $categories = $categories->read('Categories', ['CategoryID', 'CategoryName']);
...
$categoryField->defaultValue(['CategoryID' => 1, 'CategoryName' => 'Beverages']);
