...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $columns = ['ProductID', 'ProductName', 'UnitPrice', 'UnitsInStock', 'Discontinued'];
...
$productNameField->type('string')
                 ->validation(['required' => true, 'productnamevalidation' => new \Kendo\JavaScriptFunction('productnamevalidation')]);
...
<script>
    function productnamevalidation (input) {
