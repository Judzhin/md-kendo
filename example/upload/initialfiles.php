...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $type = $_GET['type'];
    $currentInitialFiles = isset($_COOKIE['initialFiles']) ? unserialize($_COOKIE['initialFiles']) : [];
...
$initialFiles = isset($_COOKIE['initialFiles']) ? unserialize($_COOKIE['initialFiles']) : [];
