...
$scheduler->timezone("Etc/UTC")
        ...
        ->group(['resources' => ['Rooms', 'Attendees'], 'orientation' => 'vertical'])
        ->addView(['type' => 'timeline', 'eventHeight' => 50, 'majorTick' => 60, 'startTime' => new DateTime('2013/6/13 7:00')],
            ['type' => 'timelineWeek', 'eventHeight' => 50, 'majorTick' => 60, 'startTime' => new DateTime('2013/6/13 7:00')],
            ['type' => 'timelineWorkWeek', 'eventHeight' => 50, 'majorTick' => 60, 'startTime' => new DateTime('2013/6/13 7:00')],
            ['type' => 'timelineMonth', 'eventHeight' => 50, 'majorTick' => 1440])
