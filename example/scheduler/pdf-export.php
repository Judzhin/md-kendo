...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $columns = ['TaskID', 'Title', 'Start', 'End', 'StartTimezone', 'EndTimezone', 'IsAllDay', 'Description', 'RecurrenceID', 'RecurrenceRule', 'RecurrenceException', 'OwnerID'];
    ...
    switch ($type) {
        ...
        case 'destroy':
            ...
            break;
        default:
            $result = $result->read('Tasks', ['TaskID', 'OwnerID'], $request);
            break;
    }
...
$scheduler->timezone("Etc/UTC")
        ...
        ->addView(['type' => 'day', 'startTime' => new DateTime('2013/6/13 7:00')],
            ['type' => 'workWeek', 'selected' => true, 'startTime' => new DateTime('2013/6/13 7:00')],
            ['type' => 'week', 'startTime' => new DateTime('2013/6/13 7:00')], 'month', 'agenda', 'timeline')
