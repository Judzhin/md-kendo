...
$scheduler->date(new DateTime('2013/6/13'))
        ->height(600)
        ->addView(
            ['type' => 'day', 'startTime' => new DateTime('2013/6/13 10:00'), 'endTime' => new DateTime('2013/6/13 23:00')],
            ['type' => 'agenda', 'startTime' => new DateTime('2013/6/13 10:00'), 'endTime' => new DateTime('2013/6/13 23:00')]
        )
        ->editable(false)
