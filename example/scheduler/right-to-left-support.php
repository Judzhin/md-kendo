...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $columns = ['TaskID', 'Title', 'Start', 'End', 'StartTimezone', 'EndTimezone', 'IsAllDay', 'Description', 'RecurrenceID', 'RecurrenceRule', 'RecurrenceException'];
    ...
    switch ($type) {
        ...
        case 'destroy':
            ...
            break;
        default:
            $result = $result->read('Tasks', ['TaskID'], $request);
            break;
    }
...
$scheduler->timezone("Etc/UTC")
    ...
    ->height(600)
    ->addView(
        ['type' => 'day', 'startTime' => new DateTime('2013/6/13 7:00', new DateTimeZone('UTC'))],
        ['type' => 'week', 'selected' => true, 'startTime' => new DateTime('2013/6/13 7:00', new DateTimeZone('UTC') )],
        'month', 'agenda')
