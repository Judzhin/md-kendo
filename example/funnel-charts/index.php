...
$series->data([
            ['category' => 'Impressions', 'value' => 434823, 'color' => '#0e5a72'],
            ['category' => 'Clicks', 'value' => 356854, 'color' => '#166f99'],
            ['category' => 'Unique Visitors', 'value' => 280022, 'color' => '#2185b4'],
            ['category' => 'Downloads', 'value' => 190374, 'color' => '#319fd2'],
            ['category' => 'Purchases', 'value' => 120392, 'color' => '#3eaee2'],
        ]);

$chart_oct = new \Kendo\Dataviz\UI\Chart('chart-oct');

$chart_oct->title(['position' => 'bottom', 'text' => 'October'])
      ->addSeriesItem($series)
      ->seriesDefaults($seriesDefault)
      ->legend(['visible' => false])
      ->tooltip(['visible' => true, 'template' => '#=dataItem.category#']);

$series = new \Kendo\Dataviz\UI\ChartSeriesItem();
$series
       ->data([
            ['category' => 'Impressions', 'value' => 984528, 'color' => '#0e5a72'],
            ['category' => 'Clicks', 'value' => 856287, 'color' => '#166f99'],
            ['category' => 'Unique Visitors', 'value' => 643694, 'color' => '#2185b4'],
            ['category' => 'Downloads', 'value' => 567843, 'color' => '#319fd2'],
            ['category' => 'Purchases', 'value' => 389137, 'color' => '#3eaee2'],
        ]);

$chart_nov = new \Kendo\Dataviz\UI\Chart('chart-nov');

$chart_nov->title(['position' => 'bottom', 'text' => 'November'])
      ->seriesDefaults($seriesDefault)
      ->addSeriesItem($series)
      ->legend(['visible' => false])
      ->tooltip(['visible' => true, 'template' => '#=dataItem.category#']);
...
$series = new \Kendo\Dataviz\UI\ChartSeriesItem();
$series->data([
            ['category' => 'Impressions', 'value' => 1200528, 'color' => '#0e5a72'],
            ['category' => 'Clicks', 'value' => 989287, 'color' => '#166f99'],
            ['category' => 'Unique Visitors', 'value' => 885694, 'color' => '#2185b4'],
            ['category' => 'Downloads', 'value' => 788843, 'color' => '#319fd2'],
            ['category' => 'Purchases', 'value' => 694137, 'color' => '#3eaee2'],
        ]);

$chart_dec = new \Kendo\Dataviz\UI\Chart('chart-dec');

$chart_dec->title(['position' => 'bottom', 'text' => 'December'])
      ->seriesDefaults($seriesDefault)
      ->addSeriesItem($series)
      ->legend(['visible' => false])
      ->tooltip(['visible' => true, 'template' => '#=dataItem.category#']);
