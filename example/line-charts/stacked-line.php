...
$categoryAxis->categories([1952, 1956, 1960, 1964, 1968, 1972, 1976, 1980, 1984, 1988, 1992, 1996, 2000, 2004, 2008, 2012])
...
$chart->title(['text' => 'Olympic Medals won by USA'])
      ...
      ->tooltip($tooltip)
      ->seriesDefaults(['type' => 'line', 'missingValues' => 'gap', 'stack' => true]);
