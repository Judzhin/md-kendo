...
function rangeBaseUnit($from, $to)
{
    ...
    } elseif ($hours < TARGET_RESULT_SIZE) {
        $result = BaseUnit::Hours;
    } elseif ($days < TARGET_RESULT_SIZE) {
        $result = BaseUnit::Days;
    } elseif ($days / DAYS_PER_WEEK < TARGET_RESULT_SIZE) {
        $result = BaseUnit::Weeks;
    } elseif ($days / DAYS_PER_MONTH < TARGET_RESULT_SIZE) {
