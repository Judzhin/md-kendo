...
$toolbar->addItem(
    ["template" => "<img src='../content/web/toolbar/user.png' class='user-image' />", "overflow" => "never"],
    ["type" => "button", "text" => "Send", "primary" => true, "overflow" => "never"],
    ...
    [
        ...
        "menuButtons" => [
            ...
            ["imageUrl" => "../content/web/toolbar/upload.png", "text" => "Forward"],
            ["imageUrl" => "../content/web/toolbar/upload.png", "text" => "Reply & Delete"]
        ]
    ],
    ["type" => "separator"],
    ["template" => "<span><label>Contacts:</label><input id='contacts' style='width: 150px;' /></span>", "overflow" => "never"],
    ["template" => "<div><label>Labels:</label><input id='labels' style='width: 150px;' /></div>", "overflowTemplate" => "<span></span>"],
    ["type" => "separator"],
    [
        "type" => "buttonGroup",
        "buttons" => [
