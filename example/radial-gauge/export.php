...
$gauge->pointer([$pointer0, $pointer1, $pointer2])
      ->scale(['minorUnit' => 5,
                    'max' => 180,
                    'startAngle' => -30,
                    'endAngle' => 210,
                    'labels' => ['position' => 'inside'], 'ranges' => [
                        ['from' => 80, 'to' => 120, 'color' => '#bb6e36'],
                        ['from' => 120, 'to' => 150, 'color' => '#b8b8b8'],
                        ['from' => 150, 'to' => 180, 'color' => '#f3ac32'],
                    ]]
      );
