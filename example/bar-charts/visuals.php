...
$chart->addSeriesItem($total, $unique)
      ...
      ->legend(['position' => 'bottom', 'item' => ['visual' => new \Kendo\JavaScriptFunction('createLegendItem')]])
      ->seriesDefaults(['type' => 'column', 'stack' => true, 'visual' => new \Kendo\JavaScriptFunction('columnVisual'), 'highlight' => ['toggle' => new \Kendo\JavaScriptFunction('toggleHandler')]])
      ->title(['text' => 'Site Visitors Stats /thousands/'])
      ->tooltip($tooltip);
?>
